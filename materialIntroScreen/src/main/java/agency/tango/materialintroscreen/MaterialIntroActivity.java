...
public abstract class MaterialIntroActivity extends AppCompatActivity {
    ...
    private AppCompatImageButton skipButton;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        backButton = (AppCompatImageButton) findViewById(R.id.button_back);
        nextButton = (AppCompatImageButton) findViewById(R.id.button_next);
        skipButton = (AppCompatImageButton) findViewById(R.id.button_skip);
